...
using Serilog;
using CashFlow.Infrastructure.Logging;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "API para consulta e reprocessamento de consolidação diária."
    });
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Consolidation API v1");
